...
public class Test11DeleteItem extends TestBase {
    ...
    @Test
    public static void deleteItemInDirectory () throws InterruptedException {
        ...
        MainPage.clickButtonDeleteItem();
        MainPage.clickButtonDelete();
        MainMenu.goToObjectsNSI();
        MainPage.showGroupInformation(NAMES);
        MainPage.showDirectoryInformation(TYPE);
        MainPage.checkItemWasDeleted();
    }
}
