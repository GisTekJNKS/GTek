...
public class Test9AddVersionOfItem extends TestBase {
    ...
    private static final String END_DATE_OF_NEW_ITEM = "2016-09-18";
    private static final String START_DATE_OF_NEW_VERSION ="2016-09-19" ;
    private static final String END_DATE_OF_NEW_VERSION = "2016-09-23";
    ...
    @Test
    public static void addVersionOfItem () throws InterruptedException {
        ...
        MainPage.clickButtonAddVersion();
        MainPage.inputStartDateVersion(START_DATE_OF_NEW_VERSION);
        MainPage.inputEndDateVersion(END_DATE_OF_NEW_VERSION);
        MainPage.clickButtonSave();
        MainMenu.goToFormationRequestForChangesPage();
        FormationRequestForChangesPage.tapAddedNewVersionOfDirectory(TYPE);
        FormationRequestForChangesPage.clickButtonSendChosen();
        FormationRequestForChangesPage.inputNameOfRequest(REQUEST_NAME);
        FormationRequestForChangesPage.clickButtonSendRequest();
        MainMenu.goToIncomingRequestsPage();
        ...
        MainPage.showDirectoryInformation(TYPE);
        MainPage.showItemInformation(NAME_OF_NEW_ITEM);
        MainPage.checkAddedVersion(START_DATE_OF_NEW_VERSION,END_DATE_OF_NEW_VERSION);
    }
}
